...
public class CharacterCardsHandler {
    ...
    private Color getChosenColor(String id) throws EriantysException{
        ...
        try {
            ...
            switch (chosen_id) {
                ...
                case 3:
                    break;
                case 4:
                    isl_index = getChosenInteger("island-4") - 1;
                    act.setIslandIndex(isl_index);
                    break;
                case 5:
                    break;
                case 6:
            ...
            PopUpLauncher cc_incomplete = new PopUpLauncher();
            cc_incomplete.setTitle("Bad request");
            cc_incomplete.setMessage("You need to specify more parameters");
            cc_incomplete.show();
            return null;
        }
    }
